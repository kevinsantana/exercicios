...
encoder = Model(inputs = autoencoder.input, outputs = \
                autoencoder.get_layer('flatten_1').output) # o valor do flatten muda a cada execucao, consultar o encoder.summary() para saber o numero certo
encoder.summary()
